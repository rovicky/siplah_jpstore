...
//
//     final mitraUser = mitraUserFromJson(jsonString);

import 'dart:convert';

MitraUser mitraUserFromJson(String str) => MitraUser.fromJson(json.decode(str));

String mitraUserToJson(MitraUser data) => json.encode(data.toJson());
...
class MitraUser {
  ...
  factory MitraUser.fromJson(Map<String, dynamic> json) => MitraUser(
